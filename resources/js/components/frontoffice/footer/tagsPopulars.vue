...
<template>
    ...
    <div class="row" v-else>
        ...
        <ul class="list-inline">
					<li class="list-inline-item" v-for="info in tagsPopularsData" :key="info.id"><span @click="tag(info.slug)" class="btn btn-outline-light btn-sm text-white" style="cursor: pointer">#{{ info.name }} </span></li>
        </ul>
    </div>
    <!-- Hot topics END -->
</template>
